...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 2. A buttonto launch the camera to take a picture
        ...
        findViewById<Button>(R.id.take_pic_button).setOnClickListener {
    ...
    fun submitPost(description : String, user: ParseUser, file: File){
        ...
        post.saveInBackground{ exception ->
            if(exception != null){
                ...
                // TODO: Show a toast user something went wrong with saving post
            } else {
